              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-5">Her-ANC<br /><span class="text-smaller">Fakultas Kedokteran dan Ilmu Kesehatan<br />Universitas Jambi<span class="text-smaller"></h1>
                    </div>
                    <form method="POST" action="{{ route('login') }}" class="user">
                        @csrf

                        <div class="form-group">
                            <input type="text" class="form-control form-control-user @error('username') is-invalid @enderror" placeholder="Username" value="{{ old('username') }}" required autofocus name="username" />
                            @error('username')
                      ...
                      <button type="submit" class="btn btn-primary bg-miku btn-user btn-block">
                        {{ __('Login') }}
                    </button>
                </form>
            </div>
